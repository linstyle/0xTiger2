...
#if !defined(SCRIPT_LIB_API)
#define SCRIPT_LIB_API __declspec(dllimport)
#endif
...
SCRIPT_LIB_API extern "C" void scriptlog_set_level(int level);
SCRIPT_LIB_API extern "C" int scriptlog_get_errno();
SCRIPT_LIB_API extern "C" void scriptlog_trace(int level, wchar_t* format, ...);